...
open class ProjectTaskStatuses {
    @field:Id
    ...
    @field:Column(name = "is_initial", nullable = false)
    open var isInitial: Boolean = false

    @field:Column(name = "is_final", nullable = false)
    open var isFinal: Boolean = false
